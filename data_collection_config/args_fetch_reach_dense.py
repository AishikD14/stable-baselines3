...
def get_args(rest_args):
    ...
    parser.add_argument('--tensorboard-log', default='logs/FetchReachDense-v4/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_ppo/models/FetchReachDense-v4/ppo_fetch_reach_dense_1M', type=str, help='Base directory for init model')
