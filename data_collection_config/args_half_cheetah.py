...
def get_args(rest_args):
    ...
    parser.add_argument('--tensorboard-log', default='logs/HalfCheetah-v5/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_ppo/models/HalfCheetah-v5/ppo_half_cheetah_1M', type=str, help='Base directory for init model')
