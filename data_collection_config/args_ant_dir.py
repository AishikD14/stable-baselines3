...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='AntDir-v0', type=str, help='Gym environment ID')
    parser.add_argument('--policy', default='MlpPolicy', type=str, help='Policy architecture')
    parser.add_argument('--verbose', default=0, type=int, help='Verbosity level')
    parser.add_argument('--seed', default=0, type=int, help='Random seed')
    parser.add_argument('--n-steps-per-rollout', default=200, type=int, help='Number of steps per rollout')
    ...
    parser.add_argument('--tensorboard-log', default='logs/AntDir-v0/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_ppo/models/AntDir-v0/ppo_antdir_1M', type=str, help='Base directory for init model')
