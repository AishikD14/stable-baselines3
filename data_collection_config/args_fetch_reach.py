...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='FetchReach-v4', type=str, help='Gym environment ID')
    ...
    parser.add_argument('--tensorboard-log', default='logs/FetchReach-v4/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_ppo/models/FetchReach-v4/ppo_fetch_reach_1M', type=str, help='Base directory for init model')
