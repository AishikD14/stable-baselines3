        ...
        for i in range(START_ITER, NUM_ITERS, SEARCH_INTERV):
            ...
            for j, a in enumerate(agents):
                ...
                if i in checkIndexes:
                    ...
                    print(f'avg return on 3 reb trajectories of agent{j}: {returns_trains1}')
                    reb_rews.append(returns_trains1)
            ...
            print(f'avg reb rews: {np.mean(reb_rews)}, std: {np.std(reb_rews)}')    
            ...
            if online_eval:
                ...
                if i in checkIndexes:
                    np.save(f'logs/{DIR}/reb_results_{i}_{i + SEARCH_INTERV}.npy', reb_rews)
            if not online_eval:
