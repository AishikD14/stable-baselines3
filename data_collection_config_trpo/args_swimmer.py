...
def get_args(rest_args):
    ...
    parser.add_argument('--tensorboard-log', default='trpo_logs/Swimmer-v5/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_trpo/models/Swimmer-v5/trpo_swimmer_1M', type=str, help='Base directory for init model')
