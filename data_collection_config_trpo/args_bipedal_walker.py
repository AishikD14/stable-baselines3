...
def get_args(rest_args):
    ...
    parser.add_argument('--n-envs', default=1, type=int, help='Number of parallel environments')
    ...
    parser.add_argument('--tensorboard-log', default='trpo_logs/BipedalWalker-v3/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_trpo/models/BipedalWalker-v3/trpo_bipedal_walker_1M', type=str, help='Base directory for init model')
