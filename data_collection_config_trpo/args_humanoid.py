...
def get_args(rest_args):
    ...
    parser.add_argument('--tensorboard-log', default='trpo_logs/Humanoid-v5/', type=str, help='Tensorboard log directory base')

    parser.add_argument('--init-model-path', default='full_exp_on_trpo/models/Humanoid-v5/trpo_humanoid_1M', type=str, help='Base directory for init model')
