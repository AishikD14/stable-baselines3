...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='HalfCheetah-v5', type=str, help='Gym environment ID')
    ...
    parser.add_argument('--target-kl', default=0.04, type=float, help='Target KL divergence for TRPO')

    parser.add_argument('--device', default='cpu', type=str, help='Device to use: cpu or cuda')
    parser.add_argument('--tensorboard-log', default='trpo_logs/HalfCheetah-v5/', type=str, help='Base directory for tensorboard logs')

    parser.add_argument('--init-model-path', default='full_exp_on_trpo/models/HalfCheetah-v5/trpo_half_cheetah_1M', type=str, help='Base directory for init model')
